...
// Colors
const BLUE = { r: 0, g: 225, b: 225 };
const GREEN = { r: 0, g: 255, b: 0 };
const ORANGE = { r: 255, g: 140, b: 0 };
const WHITE = { r: 225, g: 225, b: 225 };
const RED = { r: 255, g: 0, b: 0 };
const YELLOW = { r: 255, g: 255, b: 0 };
const PURPLE = { r: 186, g: 85, b: 211 };
const BLACK = { r: 0, g: 0, b: 0 };
const PINK = { r: 255, g: 105, b: 180 };
const allColors = [BLUE, GREEN, ORANGE, WHITE, RED, YELLOW, PURPLE, BLACK, PINK];
...
const getTarget = (() => {
    ...
    return function getTarget() {
        ...
        // Target Parameters
        // --------------------------------
        let color = pickOne([BLUE, GREEN, ORANGE, WHITE, RED, YELLOW, PURPLE, BLACK]);
        let wireframe = false;
        let health = 1;
        let maxHealth = 3;
